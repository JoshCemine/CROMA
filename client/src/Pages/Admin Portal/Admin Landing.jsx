...
const AdminLanding = ({userName}) => {
    ...
    useEffect(() => {
        async function getSignatory(){
            const response = await axios.get("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/signatory_api/getSignatories")
    ...
    const [filterDetails2, setFilterDetails2] = useState({
        ...
        async function fetchApproval(data){
            const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/admin_api/approval_table/' + data.order_filter + "/" + data.course_filter)
            console.log(response.data)
        ...
        async function fetchOngoing(data){
            const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/admin_api/ongoing_table/' + data.order_filter + "/" + data.course_filter)
            console.log(response.data)
    ...
    async function setApprovedBy(id) {
        const response = await axios.put("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/form_api/updateApproved",{
            transaction_id: id,
    ...
    async function changeStatusToAccepted(id) {
        const response = await axios.put("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/admin_api/transaction_status/" + id.toString(), {
    ...
    async function addNotif(id,message) {
        const response = await axios.post("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/notification_api/new",{
            user_id: id,
    ...
    async function setFirstSignatory(transaction_id, signatory_id) {
        const response = await axios.put("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/signatory_api/approve/",{
    ...
    async function updateRecipients(transaction_id, recipients) {
        ...
        const response = await axios.put("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/form_api/updateRecipients",{
            transaction_id: transaction_id,
