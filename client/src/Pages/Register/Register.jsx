...
const Register = ({children}) => {
    ...
    const getUserID = async(email) => {
        console.log(email)
        const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/id_api/student_id/' + email)
    ...
    async function postUpdate(data) {
        console.log(data)
        console.log(id)
        const response = axios.put('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/login_api/updateDetails',{
            user_id: parseInt(id),
