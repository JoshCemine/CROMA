...
const StudentHistoryPage = ({userId}) => {
    ...
    const [documentDetails, setDocumentDetails] = useState([]);
        ...
        async function fetchTable(filter_info) {
            const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/student_api/transaction_history/' + userId + "/" + filter_info)
        ...
        useEffect (() =>{
            ...
            const getImagevalue = async (data) => {
                const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/form_api/get/' + data)
                console.log(response)
