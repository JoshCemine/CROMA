...
const ClerkLanding = ({userName}) => {
    ...
    //https://localhost:5000/clerk_api/transaction_table/:filter_info
    ...
    async function fetchTable(data){
        const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/clerk_api/transaction_table/10/' + data.order_filter + "/" + data.course_filter)
    ...
    //     const response = await axios.post("https://localhost:5000/tracking_api/update",{
    //         transaction_id: id,
    ...
    async function approveUpdate(id) {
        const response = await axios.put("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/clerk_api/update/" + id.toString(), {
        })
        if (response){
            console.log(response)
        }
