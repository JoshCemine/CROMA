...
const SignatoryLanding = ({userId, userName, lastName}) => {
    ...
    async function fetchTable (data){
        console.log(data)
        console.log(userId)
        const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/signatory_api/transactions/' + userId + "/" + data.order_filter + "/" + data.course_filter)
    ...
    async function approveTransaction (data) {
        const response = await axios.get("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/form_api/approvedBy/" + id)
        console.log(response.data)
    ...
    async function getRecipients(id){
        addTracking(id)
        getApprovedBy(id)
        const response = await axios.get("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/form_api/formRecipients/" + id.toString())
        console.log(response)
    ...
    async function rejectUpdate(id, comment) {
        const response = await axios.put("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/signatory_api/rejecttemp/" + id.toString(), {
