...
const TrackingPage = ({userId}) => {
    ...
    console.log(id)
        async function fetchTrackingTransactions(filter_info) {
            const response = await axios.get('https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/tracking_api/history/' + userId + "/" + filter_info)
        ...
        async function getTrackingDetails(id) {
            console.log(id)
            const response = await axios.get("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/tracking_api/get/" + id)
        ...
        async function viewTransactionDetails(id) {
            console.log(id)
            var response = await axios.get("https://ec2-3-26-217-82.ap-southeast-2.compute.amazonaws.com:5000/student_api/transaction_details/" + id)
            console.log(response)
            if (response){
